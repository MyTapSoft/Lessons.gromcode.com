...
public class StorageDAO {
    ...
    public static Storage getStorage(long id) throws SQLException{
    ...
    public static Storage saveStorage(Storage storage) throws SQLException{
    ...
    public static void deleteStorage(long id) throws SQLException{
    ...
    public static Storage updateStorage(Storage storage) throws SQLException{
